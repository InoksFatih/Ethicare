...
/** Lifts embedded dark-blue lettering in the PNG without washing out the orange. */
const WORDMARK_IMG_FILTER =
  "brightness(1.07) contrast(1.06) drop-shadow(0 0 20px rgba(255,255,255,0.2)) drop-shadow(0 22px 56px rgba(0,0,0,0.42))"
...
export default function StartMenu() {
  ...
  return (
    <div
      ...
      style={{
        background: "linear-gradient(160deg, #143d4c 0%, #1a5266 30%, #288395 62%, #208090 100%)",
      }}
    >
            ...
            {!wordmarkFailed ? (
              ...
              <h1
                style={{
                  ...
                  margin: 0,
                  textAlign: "center",
                  textShadow: "0 1px 2px rgba(0,0,0,0.35), 0 8px 32px rgba(0,0,0,0.35)",
                }}
              >
                ETHI<span style={{ color: "#F59E0B" }}>CARE</span>
              </h1>
